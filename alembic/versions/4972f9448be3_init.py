...
def upgrade() -> None:
    ...
    sa.Column('vessel', sa.String(), nullable=False),
    ...
    sa.Column('delivery_status', sa.Enum('PENDING_PAYMENT', 'PAID', 'UNPAID', 'PICKED_UP', 'DELIVERED_TERMINAL', 'NO_TITLE', 'LOADED_INTO_CONTAINER', name='orderstatusenum'), nullable=False),
    ...
    sa.Column('order_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PENDING_PAYMENT', 'PAID', 'UNPAID', 'PICKED_UP', 'DELIVERED_TERMINAL', 'NO_TITLE', 'LOADED_INTO_CONTAINER', name='orderstatusenum'), nullable=False),
